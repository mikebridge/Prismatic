...
public class EventDispatchServiceTest {
    ...
    private String _articleId = "123";
    private EventDispatchService _dispatchService;
    ...
    private String _fakeCacheData = "{\"id\":\"testid\"}";
    ...
    public void  setUp() throws Exception{
        ...
        _jettyLauncher.addHandler("/event/dispatch", TestDispatchServlet.class);
        ...
        _feedCache = new FeedCache(mockPersistentJsonStore);
        when(mockPersistentJsonStore.getJson(any(String.class)))
                .thenReturn(_fakeCacheData);

        _dispatchService = new EventDispatchService(
               _articleId, _cookieStore, _feedCache, _apiKey, _jettyLauncher.getBasePath(),  "test Agent" );
    }
    @After
    ...
    @Test
    public void shouldRetrieveTheDispatchFromFeedCache() throws IOException {

        // Arrange
        FeedCache.FeedData feedData = new FeedCache.FeedData();
        _feedCache.saveManyDocs("xyz123", feedData, PrismaticFeedTest.TEST_DATA);
        ...
        // Assert
        assertThat(json, equalTo(_fakeCacheData));
    ...
    public void sendConfirmation1ShouldReturnSuccess() throws Exception {
        ...
        // Arrange
        //JsonNode node = _dispatchService.createBody("/news/blah", "/2013/my/blog", "http://www.example.com/2013/my/blog");
