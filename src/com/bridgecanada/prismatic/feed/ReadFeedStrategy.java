 ...
 * Date: 28/05/13
 */
public class ReadFeedStrategy implements IFeedStrategy {
    ...
    private String _path = "/news/read";


    public interface ReadFeedStrategyFactory {
    ...
    public IFeedStrategy next(String feedId, long start, long next, long last) {
        return new ReadFeedStrategy(start, this._baseUrl, this._apiVersionId);
    }
