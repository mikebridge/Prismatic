 ...
 * Date: 28/05/13
 */
public class SharedFeedStrategy implements IFeedStrategy {
    ...
    private String _path = "/news/shared";


    public interface SharedFeedStrategyFactory {
    ...
    public IFeedStrategy next(String feedId, long start, long next, long last) {
        return new SharedFeedStrategy(start, this._baseUrl, this._apiVersionId);
    }
}
